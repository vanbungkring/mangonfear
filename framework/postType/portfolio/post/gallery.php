					...
					echo '<div class="' . $cmsms_project_img_columns . '">' . 
						'<figure class="cmsms_img_rollover_wrap preloader">' . 
							...
							'<div class="cmsms_img_rollover">' . 
								'<a href="' . $link_href[0] . '" data-group="img_' . get_the_ID() . '" title="' . cmsms_title(get_the_ID(), false) . '" class="cmsms_image_link jackbox no_open_link"><span class="cmsms-icon-search-7"></span></a>' . 
							'</div>' . 
						'</figure>' . 
					'</div>';
