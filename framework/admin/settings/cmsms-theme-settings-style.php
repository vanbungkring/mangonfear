...
function cmsms_options_style_tabs() {
	...
	$tabs['icon'] = __('Social Icons', 'cmsmasters');
...
function cmsms_options_style_sections() {
	...
	case 'logo':
		...
		$sections['logo_section'] = __('Logo Options', 'cmsmasters');
	...
	case 'icon':
		...
		$sections['icon_section'] = __('Social Icons', 'cmsmasters');
...
function cmsms_options_style_fields($set_tab = false) {
	...
	case 'footer':
		...
		$options[] = array( 
			'section' => 'footer_section', 
			'id' => CMSMS_SHORTNAME . '_footer_logo_type', 
			'title' => __('Footer Logo Type', 'cmsmasters'), 
			'desc' => '', 
			'type' => 'radio', 
			'std' => 'image', 
			'choices' => array( 
