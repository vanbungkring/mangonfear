		...
		case 'icon':
			echo '<div class="icon_management">' . 
				'<p>' . 
					...
					'<span id="new_icon_img"' . (($meta != '') ? ' class="' . $meta . '"' : '') . '></span>' . 
					'<input id="' . $field['id'] . '_button" class="icon_choose_button button button-primary" type="button" value="' . __('Choose icon', 'cmsmasters') . '" />' . 
					'<input class="button" type="button" id="remove_icon" value="' . __('Remove icon', 'cmsmasters') . '"' . (($meta != '') ? ' style="display:inline-block;"' : '') . ' />' . 
				'</p>' . 
				'<div class="icon_choose_container icon_choose_heading"></div>' . 
			'</div>' . 
		...
		case 'social':
			...
			'<div class="icon_management">' . 
				'<p>' . 
					...
					'<input id="' . $field['id'] . '_button" class="icon_choose_button button" type="button" value="' . __('Choose icon', 'cmsmasters') . '" />' . 
				'</p>' . 
