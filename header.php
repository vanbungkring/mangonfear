...
if ( 
	...
	$cmsms_layout = get_post_meta($cmsms_page_id, 'cmsms_layout', true) !== '' ? get_post_meta($cmsms_page_id, 'cmsms_layout', true) : $cmsms_option[CMSMS_SHORTNAME . '_layout'];
	
	$cmsms_page_scheme = get_post_meta($cmsms_page_id, 'cmsms_page_scheme', true) !== '' ? get_post_meta($cmsms_page_id, 'cmsms_page_scheme', true) : 'default';
} elseif (
	is_archive() || 
	is_search() || 
	is_home() || 
